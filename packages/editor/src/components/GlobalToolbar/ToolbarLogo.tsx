...
function ToolbarLogo(props: any) {
  const reducedAnimations = props.reducedAnimations;
  return (
    <motion.div
      style={{}}
      className="owl-logo me-2"
      ...
      transition={
        reducedAnimations
          ? {}
          : {
              marginTop: { delay: props.animationDelay + 0.1, type: "spring", bounce: 0.52 },
            }
      }
    >
      <svg viewBox="0 0 125 125" xmlns="http://www.w3.org/2000/svg" width={32} height={32}>
        <path
